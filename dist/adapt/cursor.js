...
import { canonicalBody, loadCursorAdapter, loadManifest, } from "../manifest.js";
import { sha256, writeFileEnsured } from "../paths.js";
export function installCursorRules(cwd) {
    ...
    for (const ruleId of manifest.rules) {
        ...
        if (!cfg)
            throw new Error(`Missing cursor adapter entry for ${ruleId}`);
